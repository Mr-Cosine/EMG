...
void Bipolar_stepper_motor::set_all_actuation_length_based_on_forward(int actuation_length) {
  ...
  this->actuation_length_forward = (int)(this->actuation_length_forward * multiplier);
  this->actuation_length_backward = (int)(this->actuation_length_backward * multiplier);
}
